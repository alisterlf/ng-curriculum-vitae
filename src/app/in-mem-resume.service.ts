        ...
        work: [
          {
            ...
            endDate: '',
            summary:
              'Desenvolvimento de uma plataforma Backoffice usando Angular 6 e Angular Material'
          },
          {
            ...
            endDate: '2017-04-03',
            summary: 'Desenvolvimento de uma plataforma B2B usando Angular 2 e Angular Material',
            highlights: [
          ...
          },
          {
            ...
            endDate: '2015-05-04',
            summary:
              'Desenvolvimento de aplicativos para Android utilizando a plataforma Ionic (Cordova, HTML, CSS e JavaScript) com utilização do framework Angular 1.x',
            highlights: [
          ...
          },
          {
            ...
            endDate: '2014-12-01',
            summary:
              'Coordenação da equipe de Front-end e desenvolvimento dos projetos mais complexos da empresa',
            highlights: [
          ...
          },
          {
            ...
            endDate: '2014-05-01',
            summary:
              "Prestação de serviço exclusivo para a empresa McDonald's no desenvolvimento e suporte de POS (point of sale) e software relacionados",
            highlights: [
          ...
          },
          {
            ...
            endDate: '2013-06-05',
            summary:
              'Coordenação da equipe de Interface. Responsável pelo desenvolvimento dos projetos mais complexos da agência em HTML, CSS e JavaScript',
            highlights: [
          ...
          },
          {
            ...
            endDate: '2012-07-13',
            summary:
              'Líder técnico e responsável pelo treinamento da equipe em JavaScript. Responsável pelo desenvolvimento dos projetos mais complexos da agência em HTML, CSS e JavaScript',
            highlights: [
          ...
          },
          {
            ...
            endDate: '2009-07-01',
            summary:
              'Desenvolvimento (HTML e CSS) de e-mail marketing, hotsites, sites institucionais e e-commerce',
            highlights: [
        ...
        skills: [
          {
            name: 'Linguagens',
            level: '',
            keywords: ['HTML5', 'CSS3', 'JavaScript (ES6)', 'Node.js']
          },
          {
          ...
          },
          {
            ...
            level: '',
            keywords: ['React', 'Webpack', 'CSS Grid layout', 'Jasmine', 'Karma', 'Protractor']
          }
        ],
        languages: [
          {
        ...
        projects: [
          {
            ...
            description:
              'Aplicação em Angular 4 que gera um currículo a partir de um JSON baseado no https://jsonresume.org/. Essa aplicação foi criada pelos seguintes motivos:',
            highlights: [
        ...
        work: [
          {
            ...
            startDate: '2018-02-05',
            endDate: '',
            summary: 'Development of a Backoffice platform using Angular 6 and Angular Material'
          },
          {
            name: 'Mercado Eletrônico',
            description: '',
            ...
            startDate: '2015-06-01',
            endDate: '2017-04-03',
            summary: 'Development of a B2B platform using Angular 2 and Angular Material',
            highlights: [
          ...
          },
          {
            ...
            endDate: '2015-05-04',
            summary:
              'Development of Android applications using the Ionic framework (Cordova, HTML, CSS and JavaScript) with Angular framework 1.x',
            highlights: [
              'Development of a Java plugin to connect the application to a Bluetooth printer',
              'Development of an algorithm to convert color photos into a dotted B&W image for thermal printer printing'
            ]
          },
          {
            name: 'Tesla',
            ...
            endDate: '2014-12-01',
            summary:
              "Coordinator of the Front-end team and development of the company's most complex projects",
            highlights: [
          ...
          },
          {
            ...
            endDate: '2014-05-01',
            summary:
              "Service focused on develop and support of POS (point of sale) and related softwares for Mc Donald's",
            highlights: ["Developing JavaScript modules for the McDonald's POS system"]
          },
          {
            name: 'TaskRow e MarketUP',
            description: '',
            ...
            highlights: [
              'TaskRow (http://goo.gl/AjAKQj): Creating the agency management system interface (Single Page Application e responsive layout)',
          ...
          },
          {
            ...
            endDate: '2013-06-05',
            summary:
              "Coordination of the Interface team. Responsible for developing the agency's most complex projects in HTML, CSS and JavaScript",
            highlights: [
              'Development of a SPA without using frameworks to Apex Brazil',
              'Development of hotsites and Facebook fanpages with complex layout and effects'
            ]
          },
          {
            name: 'Tesla',
            ...
            endDate: '2012-07-13',
            summary:
              "Technical leader responsible for training the team in JavaScript. Responsible for developing the agency's most complex projects in HTML, CSS and JavaScript",
            highlights: [
          ...
          },
          {
            ...
            endDate: '2009-07-01',
            summary:
              'Development (HTML and CSS) of e-mail marketing, hotsites, institutional sites and e-commerce',
            highlights: [
              "Natura's e-commerce",
        ...
        skills: [
          {
            name: 'Languages',
            level: '',
            keywords: ['HTML5', 'CSS3', 'JavaScript', 'Node.js']
          },
          {
          ...
          },
          {
            ...
            keywords: [
              'Single Page Applications',
              'Responsive & Fluid Layout (FlexBox and CSS Grid Layout)',
              'Cross-browser Compatibility',
              'Web Standards',
              'Acessibilidade',
              'SEO',
          ...
          },
          {
            name: 'I am learning',
            level: '',
            keywords: ['React', 'Jasmine', 'Karma', 'Protractor']
          }
        ],
        languages: [
          {
        ...
        projects: [
          {
            name: 'Angular Curriculum Vitae',
            description:
              'Angular 4 aplication that generates a resume according to a JSON based on https://jsonresume.org/. This application was created for the following reasons:',
            highlights: [
              'Have a resume in a format compatible with GitHub Pages',
              "Full control of resume's look",
